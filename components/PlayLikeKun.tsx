...
export default function PlayLikeKun(): JSX.Element {
  ...
  return (
    ...
    >
      <div
        className="w-[98%] h-60 md:h-160 bg-center bg-contain absolute -top-70 md:-top-100"
        style={{ backgroundImage: 'url(/images/transition_1.png)' }}
      ></div>
      <div className="flex relative flex-wrap justify-center ml-60 lg:ml-0 items-start w-[75%] lg:w-3/5 rounded-[5rem] bg-gradient-to-r from-white/30 via-[#003787]/60 via-50% to-white/30">
        <div className="flex justify-center items-center my-30 w-full">
          <img src="/images/9320.png" className="w-1/4 lg:w-1/5 2xl:w-auto" />
        ...
        <p className="font-base font-semibold text-sm md:text-lg lg:text-xl text-white w-full text-center lg:mx-200 mb-20">
          {intl.formatMessage({ id: 'page.home.play.like.a.kun.text.one' })}
        </p>
        <p className="font-base font-semibold text-sm md:text-lg lg:text-xl text-white w-full text-center lg:mx-200 mb-20">
          {intl.formatMessage({ id: 'page.home.play.like.a.kun.text.two' })}
        </p>
        <p className="font-base font-semibold text-sm md:text-lg lg:text-xl text-white w-full text-center lg:mx-200 mb-60">
          {intl.formatMessage({ id: 'page.home.play.like.a.kun.text.three' })}
        </p>
        <img
          className="absolute bottom-0 -left-80 lg:-left-60"
          src="/images/kun_arms_crossed.png"
        />
      </div>
    </div>
  )
